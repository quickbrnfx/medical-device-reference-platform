...
| **UN-017** | **STKP-003 – Healthcare Provider** | **OPS-002 – Continuous Physiological Monitoring**    | The healthcare provider needs timely access to current physiological information.                                       | Supports informed clinical assessment and decision-making.              |   High   |
| **UN-018** | **STKP-003 – Healthcare Provider** | **OPS-002 – Continuous Physiological Monitoring**    | The healthcare provider needs confidence that physiological information is accurate and trustworthy.                    | Supports confident interpretation of patient condition.                 |   High   |
...
| **UN-020** | **STKP-003 – Healthcare Provider** | **OPS-003 – Clinical Assessment & Decision Support** | The healthcare provider needs to identify meaningful changes in the patient's physiological condition.                  | Supports recognition of changes that may require clinical intervention. |   High   |
